...
public class ExtendedHeader {
    ...
    public MessageLogInfo getMessageLogInfo() {
        return MessageLogInfo.get(messageTypeInfo); // Replace with appropriate conversion/casting logic
    }

    public MessageTraceInfo getMessageTraceInfo() {
        return MessageTraceInfo.get(messageTypeInfo); // Replace with appropriate conversion/casting logic
    }

    public MessageBusInfo getMessageBusInfo() {
        return MessageBusInfo.get(messageTypeInfo); // Replace with appropriate conversion/casting logic
    }

    public MessageControlInfo getMessageControlInfo() {
        return MessageControlInfo.get(messageTypeInfo); // Replace with appropriate conversion/casting logic
    }
}
